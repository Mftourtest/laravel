						...
						@endif              
							...
							<div class="shop">
                                ...
                                <div class="parce-pmbtn">
                                    ...
                                    @else
                                        @if($food['is_seafood']==1)
                                       <div class="addor">
                                            <button class="btn btn-xs btn-blue seafood" data-toggle="modal" data-target=".bs-example-modal-sm" style="padding: 0.2rem 1rem; ">重量</button>
                                            <div data-id="{{$food['id']}}" style="display: none;">
                                                <input id="weight" type="text" style="margin-left:4%;width:80%;height:3rem;font-size:16px;">
                                                <input type="hidden" data-id="{{ $food['id'] }}" data-name="{{ $food['title'.$suffix] }}"  data-price="{{ $food['price'] }}">
                                            </div>
                                        </div>
                                        @else
                                           <div class="addor">
